# Создаем основной скрипт telegram-to-vk-poster.py
...
with open("telegram-to-vk-poster.py", "w", encoding="utf-8") as f:
    f.write(main_script)

print("✅ Создан основной скрипт: telegram-to-vk-poster.py")